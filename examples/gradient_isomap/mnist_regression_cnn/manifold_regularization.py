...
from examples.gradient_isomap.mnist_regression_cnn.baseline import CNNEncoderRegressor
import warnings
...
if __name__ == "__main__":
    ...
    manifold_regularization(folder_path, CNNEncoderRegressor(), num_epochs, batch_size, lr, early_stop_patience,
                            lambda_method)

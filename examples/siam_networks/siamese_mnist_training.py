...
siam_individ.show_2d(train_labels, save_path=f'{cache_folder}/siam_graph1.png')
...
siam_individ.source_data = base_individ.source_data
siam_individ.show_2d(train_labels, save_path=f'{cache_folder}/siam_graph2.png')
siam_individ.show_3d(train_labels, title='Siamese network')

...
evo_graph = DataStructureGraph(cach_folder=cach_folder, graph_file='final_graph.pkl')
...
evolution.run()
evolution.base_individ.show_2d(train_labels, save_path=f'{cach_folder}/final_graph.png')

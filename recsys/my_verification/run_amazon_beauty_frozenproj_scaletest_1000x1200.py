...
NOTE (2026-09-17): guarded with __main__ - a sibling script without this
guard (diagnostics_workers>1 there) caused a self-sustaining fork-and-
crash loop when Windows' multiprocessing spawn re-imported it. See
run_amazon_beauty_frozenproj_scaletest_1000x1200_seed1.py's docstring.
"""
import sys, os

...
def run_openml_binary(n_times):
    datasets_folder = '../datasets/binary_classification'
            ...
            try:
                ...
                try:
                    ...
                    for n in range(n_times):
                        ...
                        df = pd.DataFrame()
                        df['BCE_train'] = [train_loss]
                        df['BCE_validation'] = [val_loss.cpu().detach().numpy()]
                        df['BCE_test'] = [test_loss.cpu().detach().numpy()]
                        ...
                        isomap_epochs = 500
                        task_epochs = 300
                        isomap_optim = torch.optim.AdamW(params=isomap_model.parameters(), lr=0.00001)
                        ...
                        for epoch in range(isomap_epochs):
                            ...
                            if epoch==0:
                                ...
                                df = pd.DataFrame()
                                df['BCE_train'] = [losses[-1]]
                                df['BCE_validation'] = [val_losses[-1]]
                                df['BCE_test'] = [test_loss.cpu().detach().numpy()]
                                df['accuracy_train'] = [train_accuracy.cpu().detach().numpy()]
                                df['accuracy_validation'] = [val_accuracy.cpu().detach().numpy()]
                                df['accuracy_test'] = [test_accuracy.cpu().detach().numpy()]
                        ...
                        df = pd.DataFrame()
                        df['BCE_train'] = [train_score]
                        df['BCE_validation'] = [val_score]
                        df['BCE_test'] = [test_score]
                        ...
                        fig.suptitle(f'Train set BCE={train_score}, accuracy={train_accuracy}')
                        plt.tight_layout()
                        ...
                        fig.suptitle(f'Validation set BCE={val_score}, accuracy={val_accuracy}')
                        plt.tight_layout()
                        ...
                        fig.suptitle(f'Test set BCE={test_score}, accuracy={test_accuracy}')
                        plt.tight_layout()
